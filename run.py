...
if __name__ == '__main__':
    ...
    Dataset_pyG = Data(x=features, edge_index=adjacency,y=labels).cuda()
    ...
    for coeff_reg in [0.001]:
        for alpha in [0.01, 0.1, 1, 10, 100]:
            ...
            gae = EGAE(features, adjacency, labels, alpha, layers=layers, acts=acts,
                       max_epoch=50, max_iter=4, coeff_reg=coeff_reg, learning_rate=learning_rate,dataset=Dataset_pyG)
